...
class Config:
    ...
    # Local Horoscope System (no external API needed)
    HOROSCOPE_SYSTEM_ENABLED = True
    DAILY_HOROSCOPE_VARIATIONS = 4  # Number of description variations per sign
    
    # Google Sheets Configuration
    GOOGLE_SHEET_ID = os.environ.get('GOOGLE_SHEET_ID') or '1mY3rIU7ZQ_mpT3jopsLd_vfYcxlFz4DUzikL41UNPiU'
    ...
    # AI Configuration
    AI_MODEL = os.environ.get('AI_MODEL') or 'gemini-2.0-flash-exp'
